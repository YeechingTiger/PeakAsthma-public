describe('RedzonemedicationinstructionsmodalCtrl', function() {
    ...
    beforeEach(inject(function($rootScope, $uibModal, $controller, peakFlowService, asthmaZoneModalManager, $q) {
      scope = $rootScope.$new();
      prescriptionLocal = {};
      modal = $controller('RedzonemedicationinstructionsmodalCtrl', {$scope: scope, prescription: prescriptionLocal});
